...
const COMBINED_FEE_DEFINITION_TEXT = `${TRANSFER_FEE_DEFINITION_TEXT}  ${NOC_FEE_DEFINITION_TEXT}`;
const AMOUNT_TO_SELLER_PAYMENT_TEXT_VARIANTS = ["Manager's Cheque or Cash.", "Manager's Cheque or Сash."];
const ADM_FEE_PAYEE_TEXT = "to be paid by the Buyer to Abu Dhabi Municipality on the transfer date by a Manager’s Cheque";
const SELLER_OUTSTANDING_NOC_PHRASE = " or No Objection Certificate (NOC)";
