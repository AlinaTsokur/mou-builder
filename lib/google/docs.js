...
export function buildConditionalTextRequests(doc, data) {
  ...
  if (!data.buyerDepositEnabled) {
    requests.push({
      replaceAllText: {
        containsText: { text: BUYER_DEFAULT_FORFEIT_TEXT, matchCase: true },
  ...
  if (!data.sellerDepositEnabled) {
    requests.push({
      replaceAllText: {
        containsText: { text: SELLER_DEFAULT_FORFEIT_TEXT, matchCase: true },
  ...
  if (!data.buyerDepositEnabled || !data.sellerDepositEnabled) {
    requests.push({
      replaceAllText: {
        containsText: { text: DEFAULT_AMOUNT_SAID_TEXT, matchCase: true },
