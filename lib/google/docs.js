...
async function createMouDocumentV2({ drive, docs, title, data, rules, replacements, flags, templateId }) {
  ...
  // 6. Контроль: неподставленные плейсхолдеры и уцелевшие маркеры.
