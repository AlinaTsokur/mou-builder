...
export const BUYER_DEFAULT_PENALTY_TEXT =
  "the <<Buyer>> shall be liable to pay the <<Seller>> an amount equal to the <<Security Deposit>>, being <<AED {{buyer_default_penalty_amount}}>>, as <<liquidated damages>>, which the <<Parties>> agree represents a genuine pre-estimate of the Seller\u2019s losses and is not a penalty.";
...
export const SELLER_DEFAULT_PENALTY_TEXT =
  "the <<Seller>> shall be liable to pay the <<Buyer>> an amount equal to the <<Security Deposit>>, being <<AED {{seller_default_penalty_amount}}>>, as <<liquidated damages>>, which the <<Parties>> agree represents a genuine pre-estimate of the Buyer\u2019s losses and is not a penalty.";
