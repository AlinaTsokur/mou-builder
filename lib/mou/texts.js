...
// --- Termination Agreement — Security Deposit phrase ---

export const TERMINATION_WITH_DEPOSIT_TEXT =
  "the allocation of the Security Deposit and any other financial or contractual consequences";

export const TERMINATION_WITHOUT_DEPOSIT_TEXT =
  "any financial or contractual consequences";

// --- Developer Approval — Security Deposit phrase ---

export const DEVELOPER_APPROVAL_WITH_DEPOSIT_TEXT =
  "and the Security Deposit shall be returned in full to the respective Party, unless";

export const DEVELOPER_APPROVAL_WITHOUT_DEPOSIT_TEXT =
  "unless";
