...
export const BUYER_DEFAULT_PENALTY_TEXT =
  "Upon the occurrence of such <<Buyer Default>>, the <<Buyer>> shall be liable to pay the <<Seller>> a fixed amount of <<AED {{buyer_default_penalty_amount}}>> as <<liquidated damages>>, which the <<Parties>> agree represents a genuine pre-estimate of the Seller's losses and is not a penalty.";
...
export const SELLER_DEFAULT_PENALTY_TEXT =
  "Upon the occurrence of such <<Seller Default>>, the <<Seller>> shall be liable to pay the <<Buyer>> a fixed amount of <<AED {{seller_default_penalty_amount}}>> as <<liquidated damages>>, which the <<Parties>> agree represents a genuine pre-estimate of the Buyer's losses and is not a penalty.";
