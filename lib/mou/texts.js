...
export const DEPOSIT_RETURN_BOTH =
  "Upon successful completion of the transfer of ownership on the Transfer Date, the Security Deposit cheque<<s>> shall be returned to the Buyer <<and to the Seller>> or cancelled and shall not be presented for payment.";
