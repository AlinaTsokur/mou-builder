...
export function calculate(data) {
  ...
  const defaultPenaltyAmount = data.sellingPrice !== "" ? data.sellingPrice * 0.1 : "";
  const defaultPenalty80 = defaultPenaltyAmount !== "" ? defaultPenaltyAmount * 0.8 : "";
  const defaultPenalty20 = defaultPenaltyAmount !== "" ? defaultPenaltyAmount * 0.2 : "";
  ...
  return {
    ...
    amountToSeller,
    buyerDepositAmount,
    buyerDeposit80: buyerDepositAmount !== "" ? buyerDepositAmount * 0.8 : defaultPenalty80,
    buyerDeposit20: buyerDepositAmount !== "" ? buyerDepositAmount * 0.2 : defaultPenalty20,
    sellerDepositAmount,
    sellerDeposit80: sellerDepositAmount !== "" ? sellerDepositAmount * 0.8 : defaultPenalty80,
    sellerDeposit20: sellerDepositAmount !== "" ? sellerDepositAmount * 0.2 : defaultPenalty20,
...
export function buildReplacements(data, calc, articleNumbers) {
  ...
  r.buyer_default_penalty_amount = money(calc.defaultPenaltyAmount);
  r.seller_default_penalty_amount = money(calc.defaultPenaltyAmount);
