...
export function calculate(data) {
  ...
  return {
    ...
    amountToSeller,
    buyerDepositAmount,
    buyerDeposit80: buyerDepositAmount !== "" ? buyerDepositAmount * 0.8 : buyerPenalty80,
    buyerDeposit20: buyerDepositAmount !== "" ? buyerDepositAmount * 0.2 : buyerPenalty20,
    sellerDepositAmount,
    sellerDeposit80: sellerDepositAmount !== "" ? sellerDepositAmount * 0.8 : sellerPenalty80,
    sellerDeposit20: sellerDepositAmount !== "" ? sellerDepositAmount * 0.2 : sellerPenalty20,
